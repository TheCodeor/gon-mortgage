      ...
      <div class="left">
        ...
        >
          <div class="d-flex flex-row align-center">
            <div class="d-flex flex-row align-center nfts">
              <img class="img ml-5" :src="item.src" alt="" />
              <div class="Nftname ml-4">
                Wake up, Astro Boy!Wake up, Astro Boy!
              </div>
            </div>
            <div class="Mortgage">Not Mortgaged</div>
            <div class="time">2023.5.15 ~ 2023.6.14 18:00:00 30 Days</div>
            <button class="btn" v-if="item.state == '1'">Mortgage</button>
            <button class="btn2" v-else-if="item.state == '2'">Redeem</button>
            <img
